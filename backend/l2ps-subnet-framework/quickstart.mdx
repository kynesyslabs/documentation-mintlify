...
<AccordionGroup>
  ...
  <Accordion title="ZK Prover not available">
    Run `src/libs/l2ps/zk/scripts/setup_all_batches.sh`. System works without ZK (graceful degradation).
  </Accordion>
</AccordionGroup>
...
cd src/libs/l2ps/zk/scripts && ./setup_all_batches.sh && cd ../../../..  # Return to project root
