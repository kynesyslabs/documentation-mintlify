...
The node software is available in the [node repository](https://github.com/kynesyslabs/node). The recommended way to run a node is via Docker Compose:
...
See the [Project Setup](/cookbook/project-setup/overview) guides and the repository's `INSTALL.md` for the full walkthrough (Docker Compose and bare-metal tracks).
