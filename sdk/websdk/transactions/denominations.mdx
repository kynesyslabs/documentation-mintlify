...
```typescript
import { Demos, denomination } from "@kynesyslabs/demosdk/websdk"
...
```typescript
import { denomination } from "@kynesyslabs/demosdk/websdk"
...
```typescript
import { Demos, denomination, SubDemPrecisionError } from "@kynesyslabs/demosdk/websdk"
