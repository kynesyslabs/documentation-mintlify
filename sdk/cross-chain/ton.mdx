---
title: "Ton"
description: "The Open Network (TON) is a decentralized and open internet, created by the community using a technology designed by Telegram."
icon: "telegram"
---
...
```bash
bun add @orbs-network/ton-access
```
