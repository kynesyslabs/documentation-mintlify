...
import { prepareXMScript } from "@kynesyslabs/demosdk/websdk"
import {
    DemosWork,
    prepareWeb2Step,
    prepareXMStep,
...
// Fallback condition — the all-null shape mirrors what
// ConditionalOperation.else() produces internally: a default branch
// that runs when no preceding condition matches.
