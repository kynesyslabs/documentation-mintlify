...
This guide explains how each Storage Program operation fits into an end-to-end workflow. For method signatures, payload schemas, and error codes, rely on the [API Reference](./api-reference). For concrete implementation patterns, see the [Storage Program Cookbook](../cookbook/storage-programs/examples).
...
**References**: [API Reference – create](./api-reference.md#sdk-methods), [Cookbook – provisioning flows](../cookbook/storage-programs/examples).
...
**References**: [API Reference – write](./api-reference.md#sdk-methods), [Cookbook – update patterns](../cookbook/storage-programs/examples).
...
**References**: [RPC Queries guide](./rpc-queries), [API Reference – read](./api-reference.md#sdk-methods).
...
**References**: [Access Control guide](./access-control), [API Reference – updateAccessControl](./api-reference.md#sdk-methods).
...
**References**: [API Reference – delete](./api-reference.md#sdk-methods), [Cookbook – teardown routines](../cookbook/storage-programs/examples).