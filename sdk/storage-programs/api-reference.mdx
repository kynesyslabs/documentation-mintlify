---
title: "Api Reference"
description: "Method-signature reference for the v4.0.3 Storage Programs SDK: every Demos accessor, StorageProgram static helper, payload type, and constant."
icon: "book"
---

# Storage Programs API Reference

This page is the deep-link reference for the Storage Programs surface of `@kynesyslabs/demosdk@v4.0.3`. Every signature, return type, and parameter shape on this page is lifted directly from the SDK source. For the narrative walkthrough, start at [Getting Started](./getting-started).
